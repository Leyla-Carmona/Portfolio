...
-> HTML Dinamico cargado con un json en un repositorio para evitar las rutas "quemadas" en el HTML dejando solo un par de textos en el mismo y el resto de manera dinámica
-> Mejorado a SPA.
